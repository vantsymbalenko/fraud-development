        ...
        <table className="table table-striped table-bordered table-hover table-sm">
          ...
          <tbody>
            ...
            <tr className="table-warning">
              <th scope="row">150</th>
              <td>
                Concerning Cases (amount of new ones, amount of ones under
                investigation, amount of cases that previously passed)
              </td>
            </tr>
            <tr className="table-danger">
              <th scope="row">100</th>
              <td>
                High-risk Cases (amount of new ones, amount of ones under
                investigation, amount of cases that previously passed)
              </td>
            </tr>
          </tbody>
